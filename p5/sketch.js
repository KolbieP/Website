...
function preload() {
  imgData = loadImage('libraries/image.jpg', img => console.log('Image 1 loaded'), () => console.error('Failed to load image 1'));
  imgData2 = loadImage('libraries/image2.jpg', img => console.log('Image 2 loaded'), () => console.error('Failed to load image 2'));
  imgData3 = loadImage('libraries/image3.jpg', img => console.log('Image 3 loaded'), () => console.error('Failed to load image 3'));
}
